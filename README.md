...
- Install modding api either
    - manually [modding API](https://github.com/hk-modding/api) (download newest release then unzip contents into 
    Hollow Knight's `Hollow Knight/Hollow Knight_Data/Managed` folder ), or 
...
### Using other mods with BonfireRevamped
